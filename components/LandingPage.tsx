...
const aiCapabilities = [
  {
    ...
    description:
      "Answers what services the business offers and helps visitors find the right next step.",
    icon: HelpCircle,
  },
  {
    title: "Pricing guidance",
    description:
      "Explains starting prices, package ranges, or tells the visitor when a quote is needed.",
    icon: WalletCards,
  },
  {
    title: "Appointment requests",
    description:
      "Collects preferred day, time, service type, and contact information for follow-up.",
    icon: CalendarCheck,
  },
  {
    title: "Location and hours",
    description:
      "Shares service areas, business hours, emergency availability, and basic directions.",
    icon: MapPin,
  },
  {
    title: "Lead qualification",
    description:
      "Asks simple questions to understand what the customer needs before your team calls.",
    icon: UsersRound,
  },
  {
    title: "Policy information",
    description:
      "Explains common policies like deposits, cancellations, consultations, or service limits.",
    icon: FileText,
  },
];
...
const faqs = [
  {
    question: "Is this only for businesses that already have a website?",
    answer:
      "No. We can help if you already have a website that needs improvement, or if you are starting from zero and need a modern website built the right way from the beginning.",
  },
  {
    question: "Does the AI assistant replace my team?",
    answer:
      "No. The goal is not to replace your team. The goal is to answer basic questions, capture lead details, and give your team better follow-up opportunities.",
  },
  {
    question: "Can the chatbot be customized for my business?",
    answer:
      "Yes. The AI flow should match your services, your customer questions, and the type of lead information you need. A home care agency needs a different flow than a barber shop, restaurant, contractor, or med spa.",
  },
  {
    question: "Do I need to understand AI or technology?",
    answer:
      "No. The entire point is to make the technology simple for the business owner. We handle the website structure, chatbot setup, lead flow, and launch guidance.",
  },
  {
    question: "Can this help if I already get traffic but not enough leads?",
    answer:
      "Yes. That is one of the best use cases. If people are already visiting your site but not contacting you, the website needs a stronger path from visitor to lead.",
  },
  {
    question: "What happens after the website is launched?",
    answer:
      "You can manage it yourself or use the Maintenance + AI Care Plan for updates, chatbot improvements, small content changes, and basic monthly review.",
  },
];
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-grid text-white">
      ...
      <section className="relative px-5 pb-20 pt-32 sm:pt-36 lg:px-8 lg:pb-28">
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1fr_0.92fr] lg:items-center">
          <div>
            ...
            >
              We build modern AI-powered websites that answer questions, capture
              leads, and help small businesses book more appointments.
            </motion.p>
            ...
            >
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-400 px-7 py-4 text-sm font-black text-slate-950 shadow-xl shadow-cyan-500/20 transition hover:bg-cyan-300"
              >
              ...
              <a
                href="#demo"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-7 py-4 text-sm font-bold text-white transition hover:border-cyan-300/40 hover:bg-white/10"
              >
                See the AI Demo
              </a>
            </motion.div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-stretch">
            <div className="rounded-3xl border border-red-300/20 bg-red-400/5 p-6 sm:p-8">
              ...
              <h2 className="text-3xl font-black tracking-tight text-white sm:text-4xl">
                A Basic Website That Only Displays Information
              </h2>
              <p className="mt-5 text-base leading-8 text-slate-300">
                Most small business websites are passive. They show services,
                phone numbers, and maybe a contact form, but they do not guide
                the visitor or create urgency.
              </p>

              <div className="mt-8 space-y-4">
                <BeforeAfterPoint
                  negative
                  text="Visitors leave when they cannot get quick answers"
                />
                <BeforeAfterPoint
                  negative
                  text="Contact forms feel cold and easy to ignore"
                />
                <BeforeAfterPoint
                  negative
                  text="After-hours traffic turns into missed opportunity"
                />
                <BeforeAfterPoint
                  negative
                  text="The website does not actively support sales"
                />
              </div>
            </div>
            ...
            <div className="glow-border rounded-3xl border border-cyan-300/30 bg-cyan-300/10 p-6 sm:p-8">
              ...
              <h2 className="text-3xl font-black tracking-tight text-white sm:text-4xl">
                An AI-Powered Website That Starts the Conversation
              </h2>
              <p className="mt-5 text-base leading-8 text-slate-300">
                Your website becomes a smarter front door for your business. It
                welcomes visitors, answers questions, captures lead details, and
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                ...
                <h3 className="mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
                  The AI flow is customized to your services, not copied from a
                  generic template.
                </h3>
              </div>
              ...
              <div className="space-y-4 text-sm leading-7 text-slate-300">
                <p>
                  A barber shop does not need the same flow as a home care
                  agency. A med spa does not need the same intake questions as a
                  contractor.
                </p>
                <p>
                  That is the real value: a website that looks modern, explains
                  the business clearly, and helps convert visitors into
      ...
      <AnimatedSection className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="A premium AI-powered website helps your business look sharper, respond faster, and turn more visitors into real opportunities."
          />
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {benefits.map((benefit) => (
              <div
                key={benefit}
                className="glass-card rounded-3xl p-5 transition hover:-translate-y-1 hover:border-cyan-300/30"
              >
                <CheckCircle2
      ...
      <AnimatedSection id="industries" className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="This offer is designed for businesses that depend on trust, phone calls, appointments, and fast customer response."
          />
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {industries.map((industry) => (
              <div
                key={industry}
                className="group rounded-3xl border border-white/10 bg-white/[0.04] p-5 transition hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-cyan-300/10"
              >
                <Store
                  className="mb-5 text-cyan-300 transition group-hover:scale-110"
                  size={28}
                  aria-hidden="true"
                />
      ...
      <AnimatedSection id="pricing" className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="Pricing"
            title="Simple Packages to Get Started"
            description="Start with a premium AI-powered website, then keep it updated and optimized with monthly support."
          />
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <PricingCard
              ...
              description="Launch a modern AI-powered website that explains your business, captures leads, and helps visitors request appointments."
              items={starterIncludes}
              cta="Start with the AI Website"
              recommended
            />

            <PricingCard
              title="Maintenance + AI Care Plan"
              price="$149"
              billing="per month"
              eyebrow="Ongoing support"
              description="Keep the site fresh after launch with updates, chatbot improvements, basic checks, and monthly performance review."
              items={careIncludes}
          ...
          <div className="mt-8 rounded-3xl border border-white/10 bg-white/[0.04] p-5 text-center">
            <p className="text-sm leading-7 text-slate-300">
              Not ready to buy yet? Start with the free website review. We’ll
              show you where your current website is losing leads and what we
              would improve first.
            </p>
          </div>
        </div>
      ...
      <AnimatedSection className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="Process"
            title="How It Works"
            description="Simple, clear, and built around helping small businesses launch without feeling overwhelmed."
          />

          <div className="mt-12 grid gap-5 md:grid-cols-4">
            {processSteps.map((step, index) => (
              <div key={step} className="glass-card relative rounded-3xl p-6">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-400 text-lg font-black text-slate-950">
                  {index + 1}
                </div>
      ...
      <AnimatedSection className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="A good AI-powered website should feel simple, practical, and useful. Here are the common questions before getting started."
          />
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-2">
            {faqs.map((item) => (
              <div
                key={item.question}
                className="glass-card rounded-3xl p-6 transition hover:-translate-y-1 hover:border-cyan-300/30"
              >
                <div className="mb-4 flex items-start gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-cyan-400/15 text-cyan-300">
      ...
      <AnimatedSection className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="glow-border relative overflow-hidden rounded-3xl border border-cyan-300/30 bg-cyan-300/10 p-8 sm:p-10 lg:p-12">
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
              <div>
                ...
                <h2 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
                  Not Sure If Your Website Is Losing Leads?
                </h2>
                <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300 sm:text-lg">
                  Send your current website and we’ll review it like a customer
                  would. You’ll get practical improvement ideas before making a
                  decision.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-6">
                <h3 className="text-xl font-black text-white">
                  Your free review looks for:
                </h3>

                <div className="mt-5 space-y-4">
                  <BeforeAfterPoint text="Where visitors may be dropping off" />
                  <BeforeAfterPoint text="Where lead capture can be improved" />
                  <BeforeAfterPoint text="How AI can help answer questions faster" />
                </div>

                <a
                  href="#contact"
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-cyan-400 px-6 py-4 text-sm font-black text-slate-950 shadow-xl shadow-cyan-500/20 transition hover:bg-cyan-300"
                >
      ...
      <AnimatedSection id="contact" className="px-5 py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <h2 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
              Ready to Make Your Website Work 24/7?
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-300">
              Send us your current website and we’ll show you 3 ways it could
              capture more leads.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <ContactPoint
                ...
                text="Review your current website experience"
              />
              <ContactPoint
                icon={TrendingUp}
                text="Find missed lead capture opportunities"
              />
              <ContactPoint
                icon={Wrench}
                text="Recommend a practical AI website upgrade"
              />
            </div>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-400">
              Modern AI websites for small businesses.
            </p>
            <p className="mt-4 text-xs text-slate-500">
              Built and Designed by The Techcorner AI LLC
            </p>
          </div>
  ...
  return (
    <div
      className={`relative flex h-full flex-col rounded-3xl p-6 sm:p-8 ${
        recommended
          ? "glow-border border border-cyan-300/30 bg-cyan-300/10"
          : "glass-card"
      }`}
    >
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        {recommended && (
          <span className="rounded-full border border-emerald-300/20 bg-emerald-400/10 px-3 py-1 text-xs font-bold text-emerald-300">
            Recommended
          </span>
        )}
      </div>
      ...
      <p className="mt-4 text-center text-xs leading-5 text-slate-500">
        Starts with a free review before any project begins.
      </p>
    </div>
  );
}

function BeforeAfterPoint({
  text,
  negative = false,
}: {
  text: string;
